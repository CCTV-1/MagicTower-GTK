...
MagicTower : ./src/game.cpp database.o music.o game_event.o game_window.o env_var.o
	g++ ./src/game.cpp database.o music.o game_event.o game_window.o env_var.o $(GCC_CPP_OPTION) $(GTKMM_FLAGS) $(GST_FLAGS) $(SQLITE3_FLAGS) $(JANSSON_FLAGS) $(LUA_FLAGS) -o ./build/bin/MagicTower
...
game_window.o : ./src/game_window.cpp ./src/game_window.h
	g++ ./src/game_window.cpp $(GCC_CPP_OPTION) $(GTKMM_FLAGS) $(GLIBMM_FLAGS) $(JANSSON_FLAGS) $(LUA_FLAGS) -c -o game_window.o
