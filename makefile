...
MagicTower : ./src/game.cpp ./build/database.o ./build/music.o ./build/game_event.o
	g++ ./src/game.cpp ./build/database.o ./build/music.o ./build/game_event.o $(GCC_CPP_OPTION) $(GTK_FLAGS) $(GST_FLAGS) $(SQLITE3_FLAGS) $(JANSSON_FLAGS) -o ./build/bin/MagicTower
...
./build/game_event.o : ./src/game_event.cpp ./src/game_event.h
	g++ ./src/game_event.cpp $(GCC_CPP_OPTION) $(GTK_FLAGS) $(JANSSON_FLAGS) -c -o ./build/game_event.o
